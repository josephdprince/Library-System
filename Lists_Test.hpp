...
TEST(ListsTest, OnlyBooks) {
	...
	Individual temp3;
	temp3.SetBook(new Book("A Confederacy of Dunces","John Kennedy Toole","comedy",2,3.4,1));
...
TEST(ListTest, ListofList) {
	...
	Individual temp4;
	temp4.SetBook(new Book("A Game of Thrones","George R. R. Martin","political/fantasy",3,4.3,1));

	Individual temp5;
	temp5.SetBook(new Book("The Color Purple","Alice Walker","fiction",26,2.1,1));
