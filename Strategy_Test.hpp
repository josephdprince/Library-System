...
TEST(StrategyTest, PopularOnly) {
	...
	Book* book2 = new Book("A Confederacy of Dunces","John Kennedy Toole","comedy",2,3.4,1);
	list.push_back(book2);

	Book* book3 = new Book("A Game of Thrones","George R. R. Martin","political/fantasy",3,4.3,1);
...
TEST(StrategyTest, LikedOnly) {
        ...
        Book* book3 = new Book("A Game of Thrones","George R. R. Martin","political/fantasy",3,2.3,1);
        list.push_back(book3);

	Book* book4 = new Book("The Giver","Lois Lowry","dystopian",40,2.3,1);
        list.push_back(book4);

	Book* book5 = new Book("The Handmaid's Tale","Margaret Atwood","dystopian",48,2.3,1);
